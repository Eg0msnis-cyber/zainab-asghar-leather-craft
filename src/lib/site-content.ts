...
export const products = [
  { id: "j1", category: "jackets" as const, en: "Onyx Biker Jacket", ar: "جاكيت بايكر أونيكس", price: "2,000 PKR" },
  { id: "j2", category: "jackets" as const, en: "Cognac Bomber", ar: "بومبر كونياك", price: "2,000 PKR" },
  { id: "j3", category: "jackets" as const, en: "Charcoal Aviator", ar: "أفياتور تشاركول", price: "2,000 PKR" },
  { id: "s1", category: "shoes" as const, en: "Heritage Oxford", ar: "أكسفورد هيريتدج", price: "1,500 PKR" },
  { id: "s2", category: "shoes" as const, en: "Burnished Derby", ar: "ديربي مصقول", price: "1,500 PKR" },
  { id: "s3", category: "shoes" as const, en: "Monk Strap Noir", ar: "مونك ستراب نوار", price: "1,500 PKR" },
  { id: "b1", category: "bags" as const, en: "Atelier Messenger", ar: "حقيبة أتيليه", price: "1,500 PKR" },
  { id: "b2", category: "bags" as const, en: "Voyager Duffle", ar: "حقيبة فوياجر", price: "1,500 PKR" },
  { id: "b3", category: "bags" as const, en: "Sialkot Tote", ar: "توت سيالكوت", price: "1,500 PKR" },
